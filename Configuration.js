...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("2", "Relative Humidity", endpointType.humiditySensor);
  endpoints.addEndpoint("3", "CO2", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.carbonDioxide);
}
